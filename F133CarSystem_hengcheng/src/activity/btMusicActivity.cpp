...
void btMusicActivity::onCreate() {
	Activity::onCreate();
    mTextView9Ptr = (ZKTextView*)findControlByID(ID_BTMUSIC_TextView9);
    mTextView8Ptr = (ZKTextView*)findControlByID(ID_BTMUSIC_TextView8);
    mTextView7Ptr = (ZKTextView*)findControlByID(ID_BTMUSIC_TextView7);
    mTextView5Ptr = (ZKTextView*)findControlByID(ID_BTMUSIC_TextView5);
    mTextView4Ptr = (ZKTextView*)findControlByID(ID_BTMUSIC_TextView4);
    mTextView6Ptr = (ZKTextView*)findControlByID(ID_BTMUSIC_TextView6);
    mTextView3Ptr = (ZKTextView*)findControlByID(ID_BTMUSIC_TextView3);
