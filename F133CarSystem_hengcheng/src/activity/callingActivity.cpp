...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_CALLING_rejectButton, onButtonClick_rejectButton,
    ID_CALLING_answerButton, onButtonClick_answerButton,
...
void callingActivity::onCreate() {
	Activity::onCreate();
    mrejectButtonPtr = (ZKButton*)findControlByID(ID_CALLING_rejectButton);
    manswerButtonPtr = (ZKButton*)findControlByID(ID_CALLING_answerButton);
