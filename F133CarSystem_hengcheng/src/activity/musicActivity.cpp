...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MUSIC_Button1, onButtonClick_Button1,
...
void musicActivity::onCreate() {
	Activity::onCreate();
    mButton1Ptr = (ZKButton*)findControlByID(ID_MUSIC_Button1);
    mTextView12Ptr = (ZKTextView*)findControlByID(ID_MUSIC_TextView12);
    mTextView11Ptr = (ZKTextView*)findControlByID(ID_MUSIC_TextView11);
    mTextView10Ptr = (ZKTextView*)findControlByID(ID_MUSIC_TextView10);
    mTextView9Ptr = (ZKTextView*)findControlByID(ID_MUSIC_TextView9);
    mTextView8Ptr = (ZKTextView*)findControlByID(ID_MUSIC_TextView8);
