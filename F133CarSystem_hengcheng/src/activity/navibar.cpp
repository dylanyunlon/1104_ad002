...
static S_ZKSeekBarCallback SZKSeekBarCallbackTab[] = {
    ID_NAVIBAR_phoneSeekBar, onProgressChanged_phoneSeekBar,
...
void navibar::onCreate() {
    ...
    mphoneButtonPtr = (ZKButton*)findControlByID(ID_NAVIBAR_phoneButton);
    mphoneSeekBarPtr = (ZKSeekBar*)findControlByID(ID_NAVIBAR_phoneSeekBar);if(mphoneSeekBarPtr!= NULL){mphoneSeekBarPtr->setSeekBarChangeListener(this);}
