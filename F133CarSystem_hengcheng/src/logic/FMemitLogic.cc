...
//				LANGUAGEMANAGER->getValue("confirm_switch_link_screen_mode").c_str());
		mLinkSwitchTipTextViewPtr->setTextTr("LinkVoice");
...
static void _sound_mode_cb(sound_mode_e mode) {
	...
	case E_SOUND_MODE_SPK:
		...
		mTextView4Ptr->setBackgroundPic("/FM/radio_fm_bg.png");
		mTextView6Ptr->setBackgroundPic(NULL);
		mTextView8Ptr->setBackgroundPic(NULL);
	...
	case E_SOUND_MODE_LINK:
		...
		mAUXButtonPtr->setSelected(false);
		mButtonFMPtr->setSelected(false);
		mTextView4Ptr->setBackgroundPic(NULL);
		mTextView6Ptr->setBackgroundPic(NULL);
		mTextView8Ptr->setBackgroundPic("/FM/radio_carpaly_bg.png");
	...
	case E_SOUND_MODE_AUX:
		...
		mButtonFMPtr->setSelected(false);
		mTextView4Ptr->setBackgroundPic(NULL);
		mTextView6Ptr->setBackgroundPic("/FM/radio_aux_bg.png");
		mTextView8Ptr->setBackgroundPic(NULL);
		mARMWindowPtr->hideWnd();
		mLinkWindowPtr->hideWnd();
		mFMWindowPtr->hideWnd();
